...
class DataGenerator():
    ...
    def __init__(self, train_dir=None, valid_dir=None, test_dir=None, bg_dir = None, meanRgb_dir=None, show=False, feedall = False):
        """ Initializer
		Args:
...
if __name__ == '__main__':
    ...
    # train_dir = '/home/sicong/detail_data/data'
    ...
    for i in range(1):
        generator._aux_generator(1, 'train', 'up-3d', 256) #)'depth_joint_train')
