...
train_dir       = '/media/sicong/137AE4175F4F2DEC/data/surreal/data/SURREAL/data/cmu/train'
valid_dir       = '/media/sicong/137AE4175F4F2DEC/data/surreal/data/SURREAL/data/cmu/valid'
test_dir        = '/media/sicong/137AE4175F4F2DEC/data/surreal/data/SURREAL/data/cmu/test'

real_train_dir = '/media/sicong/137AE4175F4F2DEC/dataset_all'
real_valid_dir = '/media/sicong/137AE4175F4F2DEC/dataset_all'
real_test_dir = '/media/sicong/137AE4175F4F2DEC/dataset_all'
...
meanRgb_dir     = '/home/sicong/HumanDepth/train/meanstd'
...
log_dir         = '/media/sicong/137AE4175F4F2DEC/log_dir_base'
model_dir       = '/media/sicong/DATA/saved_model_two_loss_biliteral/'
...
posesegdepth_model_dir = 'posesegdepth_model/'
normal_dir = '../normal_train/saved_normal_model/'
...
posesegdepth_model_dir = 'saved_model/'
normal_dir = 'saved_normal_model/'

poseseg_model_dir = 'saved_model_up3d/'
...
step_to_save 	= 200   # number of steps to save model
